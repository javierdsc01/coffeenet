 ...
 * @author Javier
 */
public class JFCreateClienteForCamarero extends javax.swing.JFrame {
    private IRepoCliente repoCliente;

    /**
     * Creates new form JFLoginCliente
     */
    public JFCreateClienteForCamarero(IRepoCliente repoCliente) {
    ...
    public boolean crearForPersonal(){
        boolean bRet = false;
        Cliente c = new Cliente(campoId.getText(), campoUsuario.getText(), 
            campoSexo.getText(), Integer.parseInt(campoPuntos.getText()),
            Integer.parseInt(campoEdad.getText()), campoPassword.getText());
        if (c == null) {
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(campoUsuario, javax.swing.GroupLayout.DEFAULT_SIZE, 74, Short.MAX_VALUE)
