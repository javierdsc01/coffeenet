 ...
 * @author Javier
 */
public class VProductActualizar {
    
    private IRepoProduct repositorio;

    public VProductActualizar(IRepoProduct repositorio) {
    ...
    */  
    public boolean actualizar() {
        int posicionNueva = Utilcmd.leerEnteroPositivo("¿De qué producto quieres cambiar los datos?: ");
        boolean bRet = false;
