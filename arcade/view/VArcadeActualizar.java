 ...
 * @author Javier
 */
public class VArcadeActualizar {
    
    private IRepoArcade repositorio;

    public VArcadeActualizar(IRepoArcade repositorio) {
    ...
    */  
    public boolean actualizar() {
        int posicionNueva = Utilcmd.leerEnteroPositivo("¿De qué arcade quieres cambiar los datos?: ");
        boolean bRet = false;
        Arcade a = pedirDatos();
        if (a == null) {
            System.out.println("No se ha creado el arcade");
        } else {
            repositorio.update(posicionNueva, a);
    ...
    * @return Boolean
    */  
    public boolean actualizarBlockTower() {
        int posicionNueva = Utilcmd.leerEnteroPositivo("¿De qué arcade quieres cambiar los datos?: ");
        boolean bRet = false;
    ...
    * @return Boolean
    */  
    public boolean actualizarGoshScape() {
        int posicionNueva = Utilcmd.leerEnteroPositivo("¿De qué arcade quieres cambiar los datos?: ");
        boolean bRet = false;
    ...
    * @return Boolean
    */  
    public boolean actualizarRacingTurbo() {
        int posicionNueva = Utilcmd.leerEnteroPositivo("¿De qué arcade quieres cambiar los datos?: ");
        boolean bRet = false;
    ...
    * @return Boolean
    */  
    public boolean actualizarStarFighter() {
        int posicionNueva = Utilcmd.leerEnteroPositivo("¿De qué arcade quieres cambiar los datos?: ");
        boolean bRet = false;
     ...
     */
    public void bucleActualizar() {
        boolean salir = false;
        int opcion;
        while (!salir) {
            System.out.println("¿Qué tipo de Arcade quieres actualizar?");
            ...
            switch (opcion) {
                case 1:
                    ...
                    break;
                case 2:
                    actualizarBlockTower();
                    break;
                case 3:
                    actualizarGoshScape();
                    break;
                case 4:
                    actualizarRacingTurbo();
                    break;
                case 5:
                    actualizarStarFighter();
                    break;
                case 0:
                    salir = true;
                    break;
