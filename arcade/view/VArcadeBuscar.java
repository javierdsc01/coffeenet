 ...
 * @author Javier
 */
public class VArcadeBuscar {
    
    private IRepoArcade repositorio;

    public VArcadeBuscar(IRepoArcade repositorio) {
    ...
    */  
    public boolean buscar(){
        Boolean bRet = false;
        Arcade arcadeBuscado = pedirDatos();
        List<Arcade> arcadesEncontrados = repositorio.searchAll(arcadeBuscado);
        if (arcadesEncontrados.isEmpty()){
            System.out.println("No se ha encontrado el arcade: " + arcadeBuscado);
        } else {
            System.out.println(Utilcmd.imprimirLista(arcadesEncontrados, "Arcade encontrados"));
            bRet = true;
        }
        return bRet;
    }
    ...
    * Busca todas las coincidencias (Search)
    */  
    public boolean buscarBlockTower(){
        Boolean bRet = false;
        Arcade arcadeBuscado = pedirDatosBlockTower();
        List<Arcade> arcadesEncontrados = repositorio.searchAll(arcadeBuscado);
        if (arcadesEncontrados.isEmpty()){
            System.out.println("No se ha encontrado el arcade: " + arcadeBuscado);
        } else {
    ...
    * Busca todas las coincidencias (Search)
    */  
    public boolean buscarGoshScape(){
        Boolean bRet = false;
        Arcade arcadeBuscado = pedirDatosGoshScape();
        List<Arcade> arcadesEncontrados = repositorio.searchAll(arcadeBuscado);
        if (arcadesEncontrados.isEmpty()){
            System.out.println("No se ha encontrado el arcade: " + arcadeBuscado);
        } else {
    ...
    * Busca todas las coincidencias (Search)
    */  
    public boolean buscarRacingTurbo(){
        Boolean bRet = false;
        Arcade arcadeBuscado = pedirDatosRacingTurbo();
        List<Arcade> arcadesEncontrados = repositorio.searchAll(arcadeBuscado);
        if (arcadesEncontrados.isEmpty()){
            System.out.println("No se ha encontrado el arcade: " + arcadeBuscado);
        } else {
    ...
    * Busca todas las coincidencias (Search)
    */  
    public boolean buscarStarFighter(){
        Boolean bRet = false;
        Arcade arcadeBuscado = pedirDatosStarFighter();
        List<Arcade> arcadesEncontrados = repositorio.searchAll(arcadeBuscado);
        if (arcadesEncontrados.isEmpty()){
            System.out.println("No se ha encontrado el arcade: " + arcadeBuscado);
        } else {
     ...
     */
    public void bucleBuscar() {
        boolean salir = false;
        int opcion;
        while (!salir) {
            System.out.println("¿Qué tipo de Arcade quieres buscar?");
